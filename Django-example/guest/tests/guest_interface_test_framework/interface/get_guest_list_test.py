...
class GetGuestListTest(unittest.TestCase):
    ...
    def test_get_event_list_eid_success(self):
        ...
        self.assertEqual(self.result['data'][0]['realname'],'Jay')
        self.assertEqual(self.result['data'][0]['phone'],'15626231223')
    ...
    def test_get_event_list_eid_phone_success(self):
        ...
        r = requests.get(self.base_url, params={'eid':3,'phone':'13611001011'})
        self.result = r.json()
        self.assertEqual(self.result['status'], 200)
        self.assertEqual(self.result['message'], 'success')
        self.assertEqual(self.result['data']['realname'],'andy')
        self.assertEqual(self.result['data']['phone'],'andy')
